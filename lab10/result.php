...
<body>
    ...
    <main class="main">
        ...
        function test_it($text)
        {
            ...
            for ($i = 0; $i < strlen($text); $i++) {
                ...
                elseif ($text[$i] != ' ') {
                    ...
                    if (function_exists('mb_strtolower') && mb_strtolower(iconv("cp1251", "utf-8", $text[$i])) == iconv("cp1251", "utf-8", $text[$i]))
                        $lowerCaseCount++;
                    else
                        $upperCaseCount++;
                }
            ...
            echo '<div class="result">Слова в исходном тексте</div><table class="result-table">';
        ...
        function test_symbs($text)
        {
            ...
            $symbs = [];
            $lText = function_exists('mb_strtolower') ? mb_strtolower(iconv("cp1251", "utf-8", $text)) : strtolower(iconv("cp1251", "utf-8", $text));
